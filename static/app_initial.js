function drawBarGraph(sampleID)
{
    ...
    { 
        ...
        dataList = divList.append("li").text(`id: ${sampleMetadata[0].id}`);
        dataList.append("li").text(`ethnicity: ${sampleMetadata[0].ethnicity}`);
        dataList.append("li").text(`gender: ${sampleMetadata[0].gender}`);
        dataList.append("li").text(`age: ${sampleMetadata[0].age}`);
        dataList.append("li").text(`location: ${sampleMetadata[0].location}`);
